              ...
              <div className="relative px-8 py-16 md:py-24 text-center">
                <div className="max-w-4xl mx-auto">
                  ...
                  <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 mb-8 max-w-3xl mx-auto leading-relaxed">
                    Uncover the truth they don&apos;t want you to see. Real
                    stories from BRICS nations, Indonesia, and Bali — where 85%
                    of humanity actually lives.
                  </p>
          ...
          <Suspense
            fallback={
              <div className="text-center py-12">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 theme-transition">
                  Loading latest news...
                </p>
              </div>
            }
                      ...
                      <div className="lg:col-span-1 space-y-6">
                        ...
                        <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 border border-emerald-200 dark:border-emerald-800 theme-transition shadow-lg shadow-emerald-100/50 dark:shadow-emerald-900/20">
                          ...
                          <p className="text-emerald-700 dark:text-emerald-300 text-sm theme-transition">
                            Unlike mainstream media owned by 6 corporations, we
                            aggregate directly from source countries. No
                            middlemen. No agenda. Just truth from where it
                            happens.
                          </p>
                        </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                    ...
                    <div className="p-3 rounded-xl bg-teal-50 dark:bg-teal-900/20 theme-transition">
                      <div className="text-2xl font-bold text-teal-600 dark:text-teal-400 theme-transition">
                        {
                          rawArticles.filter((a) => a.category === "BRICS")
                            .length
                        }
                        +
                      </div>
                    ...
                    <div className="p-3 rounded-xl bg-cyan-50 dark:bg-cyan-900/20 theme-transition">
                      <div className="text-2xl font-bold text-cyan-600 dark:text-cyan-400 theme-transition">
                        {
                          rawArticles.filter((a) => a.category === "Indonesia")
                            .length
                        }
                        +
                      </div>
        ...
        <footer className="bg-gradient-to-r from-teal-900 via-emerald-900 to-cyan-900 dark:from-teal-950 dark:via-emerald-950 dark:to-cyan-950 text-white py-8 mt-12 theme-transition relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-emerald-200 dark:text-teal-200 text-sm theme-transition">
                  While CNN and BBC feed you propaganda, we deliver raw,
                  unfiltered news from the majority world. Join millions
                  discovering what&apos;s really happening globally.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-4 text-teal-100">
                  🌊 Paradise Categories
                </h4>
                <ul className="space-y-2 text-sm">
                  <li>
                    <a
                      href="/brics"
                      className="text-teal-200 dark:text-emerald-200 hover:text-emerald-300 dark:hover:text-teal-300 theme-transition flex items-center"
                    >
                      🌺 BRICS Paradise
                    </a>
                  </li>
              ...
              <div>
                <h4 className="font-semibold mb-4 text-cyan-100">
                  🦋 Sacred Mission
                </h4>
                <p className="text-cyan-200 dark:text-teal-200 text-sm theme-transition">
                  Like the gentle waves of Bali beaches, we bring you flowing
                  perspectives from multi-polar sources and the wisdom of
                  Indonesian archipelago journalism.
                </p>
              </div>
              <div>
            ...
            <div className="border-t border-emerald-700/50 dark:border-teal-800/50 mt-8 pt-4 text-center text-sm text-emerald-300 dark:text-teal-300 theme-transition">
              <p>
                © 2024 Bali Report 🌺 Content flows from sacred sources; views
                reflect original temple wisdom.
              </p>
            </div>
          </div>
        </footer>
